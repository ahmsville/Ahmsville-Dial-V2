void AltiumSpecial() {
int index=0;
appconfig[index].appname="AltiumSpecial";
appconfig[index].ID=1;
appconfig[index].appcolor=CRGB::Brown;
appconfig[index].appanimation=solid;

appconfig[index].knob1_res=0;
appconfig[index].useapp_knob1_CW=false;//noteZOOM IN
// inbuiltfunc_knob1_CW =false
// file_knob1_CW =false
// functionscombobox_knob1_CW =
appconfig[index].knob1_CW[0]=128;
appconfig[index].knob1_CW[1]=MOUSE_MIDDLE;
appconfig[index].knob1_CW[2]=MOUSEMOVE_UP;
appconfig[index].useapp_knob1_CCW=false;//noteZOOM OUT
// inbuiltfunc_knob1_CCW =false
// file_knob1_CCW =false
// functionscombobox_knob1_CCW =
appconfig[index].knob1_CCW[0]=128;
appconfig[index].knob1_CCW[1]=MOUSE_MIDDLE;
appconfig[index].knob1_CCW[2]=MOUSEMOVE_DOWN;

appconfig[index].knob2_res=0;
appconfig[index].useapp_knob2_CW=false;//note
...
appconfig[index].useapp_knob2_CCW=false;//note
...
appconfig[index].captouch_dualtapfunc[1]=true;
appconfig[index].useapp_captouch_singletap=false;//note
...
appconfig[index].useapp_captouch_doubletap=false;//noteshelve and restore polygons
// inbuiltfunc_captouch_doubletap =false
// file_captouch_doubletap =false
// functionscombobox_captouch_doubletap =
appconfig[index].doubletap[0]='t';
appconfig[index].doubletap[1]='g';
appconfig[index].doubletap[2]='h';
...
appconfig[index].doubletap2[0]='t';
appconfig[index].doubletap2[1]='g';
appconfig[index].doubletap2[2]='e';
appconfig[index].useapp_captouch_shortpress=false;//noterepour all polygons
// inbuiltfunc_captouch_shortpress =false
// file_captouch_shortpress =false
// functionscombobox_captouch_shortpress =
appconfig[index].shortpress[0]='t';
appconfig[index].shortpress[1]='g';
appconfig[index].shortpress[2]='a';
appconfig[index].useapp_captouch_longpress=false;//noteSave Document
...
appconfig[index].MK_colors[0]=CRGB::Brown;
appconfig[index].MK_colors[1]=CRGB::Brown;
appconfig[index].MK_colors[2]=CRGB::Brown;
appconfig[index].MK_colors[3]=CRGB::Brown;
appconfig[index].MK_colors[4]=CRGB::White;
...
appconfig[index].useapp_MK1_tap=false;//notechange track size
...
appconfig[index].MK1_tap2[1]='2';
appconfig[index].MK1_tap2[2]=128;
appconfig[index].MK1_taptext="128";
appconfig[index].useapp_MK1_hold=true;//noteswitch layer
// inbuiltfunc_MK1_hold =true
// file_MK1_hold =false
// functionscombobox_MK1hold =numpad_multiply
...
appconfig[index].useapp_MK2_tap=false;//notecopy
...
appconfig[index].MK2_tap[1]=KEY_RIGHT_CTRL;
appconfig[index].MK2_tap[2]='c';
...
appconfig[index].MK3_tap[1]=KEY_RIGHT_CTRL;
appconfig[index].MK3_tap[2]='v';
...
appconfig[index].useapp_MK3_hold=false;//notepaste special
// inbuiltfunc_MK3_hold =false
// file_MK3_hold =false
// functionscombobox_MK3hold =
appconfig[index].MK3_hold[0]=128;
appconfig[index].MK3_hold[1]='e';
appconfig[index].MK3_hold[2]='a';
appconfig[index].MK3_holdtext="128";

appconfig[index].useapp_MK4_tap=false;//note3D/2D view
...
appconfig[index].MK4_tap2[2]='2';
appconfig[index].MK4_taptext="128";
appconfig[index].useapp_MK4_hold=false;//notealign to grid
// inbuiltfunc_MK4_hold =false
// file_MK4_hold =false
// functionscombobox_MK4hold =
appconfig[index].MK4_hold[0]=KEY_RIGHT_SHIFT;
appconfig[index].MK4_hold[1]=KEY_RIGHT_CTRL;
appconfig[index].MK4_hold[2]='d';
appconfig[index].MK4_holdtext="128";

appconfig[index].useapp_MK5_tap=true;//noteshow popup
// inbuiltfunc_MK5tap_SHORTCUT1 =true
// file_MK5tap_SHORTCUT1 =false
// functionscombobox_MK5tap_SHORTCUT1 =Open_PopUp
appconfig[index].MK5_tap[0]=128;
appconfig[index].MK5_tap[1]=128;
appconfig[index].MK5_tap[2]=KEY_DELETE;
...
appconfig[index].useapp_spacenav_tiltdown=false;//note
...
appconfig[index].useapp_spacenav_tiltright=false;//note
...
appconfig[index].useapp_spacenav_tiltleft=false;//note
...
appconfig[index].useapp_spacenav_slideup=false;//note
...
appconfig[index].useapp_spacenav_slidedown=false;//note
...
appconfig[index].useapp_spacenav_slideright=false;//note
...
appconfig[index].useapp_spacenav_slideleft=false;//note
