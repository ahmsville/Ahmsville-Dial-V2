void PCB_Editor() {
int index=6;
appconfig[index].appname="PCB_Editor";
appconfig[index].ID=7;
appconfig[index].appcolor=CRGB::MediumBlue;
...
appconfig[index].knob1_CW[0]=KEY_RIGHT_CTRL;
...
appconfig[index].knob1_CCW[0]=KEY_RIGHT_CTRL;
appconfig[index].knob1_CCW[1]='-';
...
appconfig[index].MK_colors[0]=CRGB::MediumBlue;
appconfig[index].MK_colors[1]=CRGB::LawnGreen;
appconfig[index].MK_colors[2]=CRGB::BlueViolet;
appconfig[index].MK_colors[3]=CRGB::MediumBlue;
appconfig[index].MK_colors[4]=CRGB::OrangeRed;
appconfig[index].MK_animation[0]=solid;
appconfig[index].MK_animation[1]=Breath;
appconfig[index].MK_animation[2]=ColorWheel;
appconfig[index].MK_animation[3]=solid;
appconfig[index].MK_animation[4]=Cardio;

appconfig[index].useapp_MK1_tap=false;//notestart routing
// inbuiltfunc_MK1tap_SHORTCUT1 =false
// file_MK1tap_SHORTCUT1 =false
// functionscombobox_MK1tap_SHORTCUT1 =
appconfig[index].MK1_tap[0]='x';
...
appconfig[index].useapp_MK4_hold=false;//noteUNDO
// inbuiltfunc_MK4_hold =false
// file_MK4_hold =false
// functionscombobox_MK4hold =
appconfig[index].MK4_hold[0]=KEY_RIGHT_CTRL;
appconfig[index].MK4_hold[1]='z';
appconfig[index].MK4_hold[2]=128;
appconfig[index].MK4_holdtext="128";

appconfig[index].useapp_MK5_tap=true;//noteopen popup
...
appconfig[index].MK5_hold[0]=KEY_DELETE;
