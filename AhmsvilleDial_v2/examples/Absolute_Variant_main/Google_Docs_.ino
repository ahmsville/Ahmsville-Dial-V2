void Google_Docs() {
int index=5;
appconfig[index].appname="Google_Docs";
appconfig[index].ID=6;
appconfig[index].appcolor=CRGB::Orange;
...
appconfig[index].MK_colors[0]=CRGB::SpringGreen;
...
appconfig[index].MK_animation[0]=Breath;
...
appconfig[index].MK1_taptext="Pick 'N' Place Wheel";
