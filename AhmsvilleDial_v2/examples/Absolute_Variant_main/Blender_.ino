void Blender() {
int index=2;
appconfig[index].appname="Blender";
appconfig[index].ID=3;
appconfig[index].appcolor=CRGB::Goldenrod;
...
// file_knob1_CW =false
// functionscombobox_knob1_CW =BLENDER_zoomIn
...
appconfig[index].useapp_captouch_doubletap=false;//note
...
appconfig[index].MK_colors[0]=CRGB::Orange;
appconfig[index].MK_colors[1]=CRGB::OrangeRed;
appconfig[index].MK_colors[2]=CRGB::Navy;
appconfig[index].MK_colors[3]=CRGB::OrangeRed;
...
appconfig[index].useapp_MK1_tap=true;//noteEnable/Disable auto orientation lock
// inbuiltfunc_MK1tap_SHORTCUT1 =true
// file_MK1tap_SHORTCUT1 =false
// functionscombobox_MK1tap_SHORTCUT1 =_BLENDER_auto_orientationLock
...
appconfig[index].useapp_MK2_tap=true;//notezoom to fit model
// inbuiltfunc_MK2tap_SHORTCUT1 =true
// file_MK2tap_SHORTCUT1 =false
// functionscombobox_MK2tap_SHORTCUT1 =BLENDER_zoomToFit
...
appconfig[index].useapp_MK4_tap=true;//notespacenav mode (tilt/slide or both)
// inbuiltfunc_MK4tap_SHORTCUT1 =true
// file_MK4tap_SHORTCUT1 =false
// functionscombobox_MK4tap_SHORTCUT1 =_BLENDER_change_viewmode
...
appconfig[index].spacenav_func=5;
appconfig[index].spacenav_continuousmode[0]=true;
...
appconfig[index].spacenav_tiltup[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltup[1]=MOUSEMOVE_UP;
...
appconfig[index].spacenav_tiltdown[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltdown[1]=MOUSEMOVE_DOWN;
...
appconfig[index].spacenav_tiltright[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltright[1]=MOUSEMOVE_RIGHT;
...
appconfig[index].spacenav_tiltleft[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltleft[1]=MOUSEMOVE_LEFT;
