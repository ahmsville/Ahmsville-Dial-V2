...
appconfig[index].ID=4;//default
appconfig[index].appcolor=CRGB::Aqua;
appconfig[index].appanimation=solid;

appconfig[index].knob1_res=0;
appconfig[index].useapp_knob1_CW=true;//notevolume++
...
appconfig[index].useapp_knob1_CCW=true;//notevolume--
...
appconfig[index].useapp_knob2_CW=true;//noteplay next
// inbuiltfunc_knob2_CW =true
// file_knob2_CW =false
// functionscombobox_knob2_CW =media_next
appconfig[index].knob2_CW[0]=128;
appconfig[index].knob2_CW[1]=128;
appconfig[index].knob2_CW[2]=128;
appconfig[index].useapp_knob2_CCW=true;//noteplay prev
// inbuiltfunc_knob2_CCW =true
// file_knob2_CCW =false
// functionscombobox_knob2_CCW =media_prev
...
appconfig[index].useapp_captouch_singletap=true;//notepause/play
...
appconfig[index].useapp_captouch_doubletap=true;//notestop
// inbuiltfunc_captouch_doubletap =true
// file_captouch_doubletap =false
// functionscombobox_captouch_doubletap =media_stop
...
appconfig[index].useapp_captouch_longpress=false;//note
// inbuiltfunc_captouch_longpress =false
// file_captouch_longpress =true
// functionscombobox_captouch_longpress =C:\Users\ahmsv\Documents\resume point.txt
...
appconfig[index].MK_tapfunc[0]=false;
appconfig[index].MK_tapfunc[1]=true;
appconfig[index].MK_tapfunc[2]=false;
...
appconfig[index].MK_colors[0]=CRGB::Gold;
appconfig[index].MK_colors[1]=CRGB::Red;
appconfig[index].MK_colors[2]=CRGB::Blue;
appconfig[index].MK_colors[3]=CRGB::ForestGreen;
...
appconfig[index].useapp_MK1_tap=false;//note
// inbuiltfunc_MK1tap_SHORTCUT1 =true
// file_MK1tap_SHORTCUT1 =false
// functionscombobox_MK1tap_SHORTCUT1 =F5
...
appconfig[index].MK1_taptext=" 0";
appconfig[index].useapp_MK1_hold=false;//note
...
appconfig[index].useapp_MK2_tap=false;//note
// inbuiltfunc_MK2tap_SHORTCUT1 =true
// file_MK2tap_SHORTCUT1 =false
// functionscombobox_MK2tap_SHORTCUT1 =numpad_multiply
...
appconfig[index].useapp_MK2_hold=false;//note
...
appconfig[index].useapp_MK3_tap=false;//note
...
appconfig[index].useapp_MK4_tap=false;//note
...
appconfig[index].useapp_MK4_hold=false;//note
...
appconfig[index].useapp_MK5_tap2=true;
// inbuiltfunc_MK5tap_SHORTCUT2 =false
// file_MK5tap_SHORTCUT2 =false
// functionscombobox_MK5tap_SHORTCUT2 =volume_up
...
appconfig[index].useapp_MK5_hold=false;//note
...
appconfig[index].spacenav_slideup[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_slideup[1]=MOUSEMOVE_UP;
...
appconfig[index].spacenav_slidedown[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_slidedown[1]=MOUSEMOVE_DOWN;
...
appconfig[index].spacenav_slideright[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_slideright[1]=MOUSEMOVE_RIGHT;
...
appconfig[index].spacenav_slideleft[0]=MOUSE_MIDDLE;
appconfig[index].spacenav_slideleft[1]=MOUSEMOVE_LEFT;
