void Horizon() {
int index=9;
appconfig[index].appname="Horizon";
appconfig[index].ID=10;
appconfig[index].appcolor=CRGB::Azure;
appconfig[index].appanimation=Breath;
...
appconfig[index].spacenav_tiltup[0]='w';
...
appconfig[index].spacenav_tiltdown[0]='s';
...
appconfig[index].spacenav_tiltright[0]='d';
...
appconfig[index].spacenav_tiltleft[0]='a';
