void Altium() {
int index=1;
appconfig[index].appname="Altium";
...
appconfig[index].useapp_MK2_tap=false;//notetab / properties
...
appconfig[index].MK2_tap[2]=KEY_TAB;
...
appconfig[index].useapp_MK3_tap=false;//noteRouting
...
appconfig[index].useapp_MK3_hold=false;//notecreate region
// inbuiltfunc_MK3_hold =false
// file_MK3_hold =false
// functionscombobox_MK3hold =
appconfig[index].MK3_hold[0]='t';
appconfig[index].MK3_hold[1]='v';
appconfig[index].MK3_hold[2]='e';
