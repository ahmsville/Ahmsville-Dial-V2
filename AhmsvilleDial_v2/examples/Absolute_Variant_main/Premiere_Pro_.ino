void Premiere_Pro() {
int index=7;
appconfig[index].appname="Premiere_Pro";
appconfig[index].ID=8;
appconfig[index].appcolor=CRGB::BlueViolet;
appconfig[index].appanimation=solid;

appconfig[index].knob1_res=0;
appconfig[index].useapp_knob1_CW=false;//noteframe ++
// inbuiltfunc_knob1_CW =false
// file_knob1_CW =false
// functionscombobox_knob1_CW =
appconfig[index].knob1_CW[0]=KEY_RIGHT_ARROW;
appconfig[index].knob1_CW[1]=128;
appconfig[index].knob1_CW[2]=128;
appconfig[index].useapp_knob1_CCW=false;//noteframe --
// inbuiltfunc_knob1_CCW =false
// file_knob1_CCW =false
// functionscombobox_knob1_CCW =
appconfig[index].knob1_CCW[0]=KEY_LEFT_ARROW;
...
appconfig[index].knob2_CW[0]=KEY_RIGHT_SHIFT;
appconfig[index].knob2_CW[1]=KEY_UP_ARROW;
...
appconfig[index].useapp_captouch_shortpress=false;//note
...
appconfig[index].useapp_captouch_longpress=false;//notesave
// inbuiltfunc_captouch_longpress =false
// file_captouch_longpress =false
// functionscombobox_captouch_longpress =
appconfig[index].longpress[0]=KEY_RIGHT_CTRL;
appconfig[index].longpress[1]='s';
...
appconfig[index].MK_colors[0]=CRGB::Yellow;
appconfig[index].MK_colors[1]=CRGB::OliveDrab;
appconfig[index].MK_colors[2]=CRGB::MidnightBlue;
appconfig[index].MK_colors[3]=CRGB::OliveDrab;
...
appconfig[index].MK1_tap2[0]='v';
appconfig[index].MK1_tap2[1]=128;
appconfig[index].MK1_tap2[2]=128;
appconfig[index].MK1_taptext="128";
appconfig[index].useapp_MK1_hold=false;//noteclear in n out
// inbuiltfunc_MK1_hold =false
// file_MK1_hold =false
// functionscombobox_MK1hold =
appconfig[index].MK1_hold[0]=KEY_RIGHT_CTRL;
appconfig[index].MK1_hold[1]=KEY_RIGHT_SHIFT;
appconfig[index].MK1_hold[2]='X';
appconfig[index].MK1_holdtext="128";

appconfig[index].useapp_MK2_tap=false;//notezoom out sequence
...
appconfig[index].useapp_MK4_hold=false;//noteselect
// inbuiltfunc_MK4_hold =false
// file_MK4_hold =false
// functionscombobox_MK4hold =
appconfig[index].MK4_hold[0]='v';
...
appconfig[index].MK5_tap[0]=KEY_DELETE;
