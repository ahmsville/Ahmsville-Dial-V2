...
appconfig[index].appcolor=CRGB::SpringGreen;
...
appconfig[index].knob1_CW[0]=KEY_LEFT_SHIFT;
...
appconfig[index].knob1_CCW[1]=KEY_LEFT_ALT;
...
appconfig[index].singletap[0]=KEY_RIGHT_ALT;
...
appconfig[index].useapp_captouch_doubletap=true;//note
