...
appconfig[index].useapp_knob2_CCW=true;//notezoom out
...
appconfig[index].useapp_captouch_singletap=true;//notespacenav mode (tilt/slide or both)
// inbuiltfunc_captouch_singletap =true
// file_captouch_singletap =false
// functionscombobox_captouch_singletap =_FU360_change_viewmode
...
appconfig[index].useapp_captouch_doubletap=true;//notezoom to fit
// inbuiltfunc_captouch_doubletap =true
// file_captouch_doubletap =false
// functionscombobox_captouch_doubletap =SW_zoomToFit
...
appconfig[index].useapp_captouch_shortpress=true;//noteEnable/Disable auto orientation lock
// inbuiltfunc_captouch_shortpress =true
// file_captouch_shortpress =false
// functionscombobox_captouch_shortpress =_FU360_auto_orientationLock
appconfig[index].shortpress[0]=128;
appconfig[index].shortpress[1]=128;
appconfig[index].shortpress[2]=128;
appconfig[index].useapp_captouch_longpress=true;//noteshow popup
// inbuiltfunc_captouch_longpress =true
// file_captouch_longpress =false
// functionscombobox_captouch_longpress =Open_PopUp
...
appconfig[index].useapp_MK5_tap=false;//note
...
appconfig[index].useapp_spacenav_slideleft=true;//note
// inbuiltfunc_Spacenav_slideleft =false
// file_Spacenav_slideleft =false
// functionscombobox_Spacenav_slideleft =SW_move_xneg
