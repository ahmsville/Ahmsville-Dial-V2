...
appconfig[index].useapp_knob1_CCW=false;//note
...
appconfig[index].useapp_captouch_doubletap=true;//notezoom to fit model
// inbuiltfunc_captouch_doubletap =true
// file_captouch_doubletap =false
// functionscombobox_captouch_doubletap =BLENDER_zoomToFit
...
// functionscombobox_captouch_shortpress =_BLENDER_auto_orientationLock
