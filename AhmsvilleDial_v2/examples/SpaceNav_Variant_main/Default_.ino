...
appconfig[index].knob1_CW[2]=MOUSEMOVE_RIGHT;
...
appconfig[index].knob1_CCW[2]=MOUSEMOVE_LEFT;
...
appconfig[index].useapp_captouch_singletap=true;//noteplay/pause
