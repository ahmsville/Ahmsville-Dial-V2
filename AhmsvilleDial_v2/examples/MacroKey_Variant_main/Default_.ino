...
appconfig[index].appcolor=CRGB::DarkMagenta;
...
appconfig[index].MK_colors[0]=CRGB::DarkMagenta;
appconfig[index].MK_colors[1]=CRGB::DarkMagenta;
appconfig[index].MK_colors[2]=CRGB::AliceBlue;
appconfig[index].MK_colors[3]=CRGB::Chartreuse;
