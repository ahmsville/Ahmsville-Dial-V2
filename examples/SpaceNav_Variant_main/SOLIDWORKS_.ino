...
appconfig[index].appcolor=CRGB::OrangeRed;
...
// functionscombobox_captouch_singletap =SW_zoomToFit
...
appconfig[index].useapp_spacenav_tiltup=true;
...
appconfig[index].useapp_spacenav_tiltdown=true;
...
appconfig[index].useapp_spacenav_tiltright=true;
...
appconfig[index].useapp_spacenav_tiltleft=true;
...
appconfig[index].useapp_spacenav_slideup=true;
...
appconfig[index].useapp_spacenav_slidedown=true;
...
appconfig[index].useapp_spacenav_slideright=true;
...
appconfig[index].useapp_spacenav_slideleft=true;
