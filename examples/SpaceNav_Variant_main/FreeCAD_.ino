void FreeCAD() {
int index=1;
appconfig[index].appname="FreeCAD";
appconfig[index].ID=2;
appconfig[index].appcolor=CRGB::SlateBlue;
...
appconfig[index].knob1_CW[1]=KEY_RIGHT_CTRL;
appconfig[index].knob1_CW[2]='+';
...
appconfig[index].knob1_CCW[1]=KEY_RIGHT_CTRL;
appconfig[index].knob1_CCW[2]='-';
...
appconfig[index].knob2_CW[1]=KEY_RIGHT_CTRL;
appconfig[index].knob2_CW[2]='+';
...
appconfig[index].knob2_CCW[1]=KEY_RIGHT_CTRL;
appconfig[index].knob2_CCW[2]='-';
...
appconfig[index].singletap[1]='v';
appconfig[index].singletap[2]='f';
...
appconfig[index].doubletap[2]=KEY_SPACEBAR;
...
appconfig[index].spacenav_continuousmode[1]=true;
...
appconfig[index].spacenav_tiltup[0]=KEY_LEFT_SHIFT;
appconfig[index].spacenav_tiltup[1]=MOUSE_RIGHT;
...
appconfig[index].spacenav_tiltdown[0]=KEY_LEFT_SHIFT;
appconfig[index].spacenav_tiltdown[1]=MOUSE_RIGHT;
...
appconfig[index].spacenav_tiltright[0]=KEY_LEFT_SHIFT;
appconfig[index].spacenav_tiltright[1]=MOUSE_RIGHT;
...
appconfig[index].spacenav_tiltleft[0]=KEY_LEFT_SHIFT;
appconfig[index].spacenav_tiltleft[1]=MOUSE_RIGHT;
...
appconfig[index].spacenav_slideup[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_slideup[2]=MOUSEMOVE_UP;
...
appconfig[index].spacenav_slidedown[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_slidedown[2]=MOUSEMOVE_DOWN;
...
appconfig[index].spacenav_slideright[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_slideright[2]=MOUSEMOVE_RIGHT;
...
appconfig[index].spacenav_slideleft[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_slideleft[2]=MOUSEMOVE_LEFT;
