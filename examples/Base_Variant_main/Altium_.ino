...
appconfig[index].appcolor=CRGB::SaddleBrown;
appconfig[index].appanimation=solid;

appconfig[index].knob1_res=90;
appconfig[index].useapp_knob1_CW=false;
// inbuiltfunc_knob1_CW =false
// file_knob1_CW =false
// functionscombobox_knob1_CW =
appconfig[index].knob1_CW[0]=MOUSE_MIDDLE;
appconfig[index].knob1_CW[1]=MOUSEMOVE_UP;
...
appconfig[index].knob1_CCW[0]=MOUSE_MIDDLE;
appconfig[index].knob1_CCW[1]=MOUSEMOVE_DOWN;
