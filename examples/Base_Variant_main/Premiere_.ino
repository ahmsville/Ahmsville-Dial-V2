void Premiere() {
int index=1;
appconfig[index].appname="Premiere";
...
appconfig[index].knob1_CW[1]=KEY_RIGHT_SHIFT;
appconfig[index].knob1_CW[2]=KEY_RIGHT_ARROW;
...
appconfig[index].knob1_CCW[1]=KEY_RIGHT_SHIFT;
appconfig[index].knob1_CCW[2]=KEY_LEFT_ARROW;
/*
