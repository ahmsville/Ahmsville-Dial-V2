...
appconfig[index].knob1_CCW[2]='2';

appconfig[index].knob2_res=0;
appconfig[index].useapp_knob2_CW=true;
// inbuiltfunc_knob2_CW =true
// file_knob2_CW =false
// functionscombobox_knob2_CW =up
appconfig[index].knob2_CW[0]=128;
appconfig[index].knob2_CW[1]=128;
appconfig[index].knob2_CW[2]='3';
appconfig[index].useapp_knob2_CCW=true;
// inbuiltfunc_knob2_CCW =true
// file_knob2_CCW =false
// functionscombobox_knob2_CCW =down
appconfig[index].knob2_CCW[0]=128;
appconfig[index].knob2_CCW[1]=128;
appconfig[index].knob2_CCW[2]='4';
...
appconfig[index].useapp_captouch_doubletap=true;
// inbuiltfunc_captouch_doubletap =true
// file_captouch_doubletap =false
// functionscombobox_captouch_doubletap =media_next
...
// functionscombobox_MK1tap_SHORTCUT1 =media_PlayPause
...
// file_MK1_hold =false
// functionscombobox_MK1hold =media_stop
...
// inbuiltfunc_Spacenav_tiltup =true
// file_Spacenav_tiltup =false
// functionscombobox_Spacenav_tiltup =volume_up
appconfig[index].spacenav_tiltup[0]=128;
appconfig[index].spacenav_tiltup[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltup[2]=MOUSEMOVE_UP;
appconfig[index].useapp_spacenav_tiltdown=false;
// inbuiltfunc_Spacenav_tiltdown =true
// file_Spacenav_tiltdown =false
// functionscombobox_Spacenav_tiltdown =volume_down
appconfig[index].spacenav_tiltdown[0]=128;
appconfig[index].spacenav_tiltdown[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltdown[2]=MOUSEMOVE_DOWN;
...
appconfig[index].spacenav_tiltright[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltright[2]=MOUSEMOVE_RIGHT;
...
appconfig[index].spacenav_tiltleft[1]=MOUSE_MIDDLE;
appconfig[index].spacenav_tiltleft[2]=MOUSEMOVE_LEFT;
...
appconfig[index].spacenav_slideup[0]=MOUSEMOVE_UP;
...
appconfig[index].spacenav_slidedown[0]=MOUSEMOVE_DOWN;
...
appconfig[index].spacenav_slideright[0]=MOUSEMOVE_RIGHT;
...
appconfig[index].spacenav_slideleft[0]=MOUSEMOVE_LEFT;
