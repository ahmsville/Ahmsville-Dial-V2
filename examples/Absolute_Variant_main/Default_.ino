...
appconfig[index].knob2_CW[2]=KEY_RIGHT_ARROW;
...
appconfig[index].knob2_CCW[2]=KEY_LEFT_ARROW;
...
appconfig[index].spacenav_tiltup[0]=MOUSEMOVE_UP;
...
appconfig[index].spacenav_tiltdown[0]=MOUSEMOVE_DOWN;
...
appconfig[index].spacenav_tiltright[0]=MOUSEMOVE_RIGHT;
...
appconfig[index].spacenav_tiltleft[0]=MOUSEMOVE_LEFT;
