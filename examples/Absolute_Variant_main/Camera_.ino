void Camera() {
int index=5;
appconfig[index].appname="Camera";
appconfig[index].ID=6;
appconfig[index].appcolor=CRGB::SeaGreen;
...
appconfig[index].knob1_CW[1]=KEY_UP_ARROW;
...
appconfig[index].knob1_CCW[1]=KEY_DOWN_ARROW;
