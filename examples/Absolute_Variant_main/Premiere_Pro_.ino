...
appconfig[index].knob2_CW[1]=KEY_RIGHT_ARROW;
...
appconfig[index].knob2_CCW[1]=KEY_LEFT_ARROW;
...
appconfig[index].MK_dualtapfunc[0]=true;
...
appconfig[index].MK_colors[4]=CRGB::Crimson;
