void Audition() {
int index=4;
appconfig[index].appname="Audition";
appconfig[index].ID=5;
appconfig[index].appcolor=CRGB::DarkBlue;
...
appconfig[index].knob1_CW[0]=KEY_RIGHT_SHIFT;
appconfig[index].knob1_CW[1]=KEY_RIGHT_ARROW;
...
appconfig[index].knob1_CCW[0]=KEY_RIGHT_SHIFT;
appconfig[index].knob1_CCW[1]=KEY_LEFT_ARROW;
appconfig[index].knob1_CCW[2]=128;

appconfig[index].knob2_res=80;
appconfig[index].useapp_knob2_CW=false;
// inbuiltfunc_knob2_CW =false
// file_knob2_CW =false
// functionscombobox_knob2_CW =
appconfig[index].knob2_CW[0]=KEY_RIGHT_ARROW;
...
appconfig[index].knob2_CCW[0]=KEY_LEFT_ARROW;
...
appconfig[index].MK_colors[0]=CRGB::DarkBlue;
appconfig[index].MK_colors[1]=CRGB::Snow;
appconfig[index].MK_colors[2]=CRGB::DarkBlue;
appconfig[index].MK_colors[3]=CRGB::Snow;
appconfig[index].MK_colors[4]=CRGB::DarkRed;
